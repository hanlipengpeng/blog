...
public class FsDirectory extends Directory {
	...
	public FsDirectory(FileSystem fs, Path directory, boolean create,
	...
	public long fileModified(String name) {
		...
		try {
			status = fs.listStatus(new Path(directory, name));
		} catch (IOException e) {
			e.printStackTrace();
		}
	...
	public IndexOutput createOutput(String name) throws IOException {
		...
		if (fs.exists(file) && !fs.delete(file, false)) // delete existing, if
														// any
	...
	public IndexInput openInput(String name) throws IOException {
		return new DfsIndexInput(new Path(directory, name),
	...
	private class DfsIndexInput extends BufferedIndexInput {
		...
		public DfsIndexInput(Path path, int ioFileBufferSize)
				throws IOException {
	...
	private class DfsIndexOutput extends BufferedIndexOutput {
		...
		public DfsIndexOutput(Path path, int ioFileBufferSize)
				throws IOException {

			// create a temporary local file and set it to delete on exit
			String randStr = Integer.toString(new Random()
	...
	public static void main(String[] args) {
		System.out.println("test FsDirectory");
	}
}
